      ...
      Class("VendingMachine") {
        ...
        Function("vend") {
          ...
          Guard {
            ...
            Throw(Call("VendingMachineError.insufficientFunds") {
              ParameterExp(name: "coinsNeeded", value: Infix("-") {
                VariableExp("item").property("price")
                VariableExp("coinsDeposited")
              })
            })
